...
//           <div>
//             <h3 className="mx-auto">Income tacker</h3>
//           </div>
//           <div>
...
//         <div className="col-md-3 border px-2" style={{ minHeight: "50vh" }}>
...
//               {/* <label htmlFor="item"></label>product{" "} */}
//               <div className="col-6">
//                 <select
...
//         <div className="d-flex flex-column col-md-4  ms-2">
//           <div>
//             <h3 className="mx-auto">expense tacker</h3>
//           </div>
//           <div>
